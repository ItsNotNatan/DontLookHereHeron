...
export default function EditarLote({ aberto, onClose, idsSelecionados, onSalvar }) {
  ...
  const estadoInicial = {
    ...
    valor_nf: '', valor: '', validacao_pep: '', registrado_sap: ''
  };
        ...
        <div className="batch-modal__body">
          ...
          <div className="batch-modal__grid batch-modal__grid--cols-3">
            ...
            <div className="batch-modal__field-card"><label className="batch-modal__label">Data Coleta</label>
              <input type="date" name="data_coleta" value={valores.data_coleta} onChange={handleChange} className="batch-modal__input" />
            </div>
            ...
            <div className="batch-modal__field-card"><label className="batch-modal__label">Data Entrega</label>
              <input type="date" name="data_entrega" value={valores.data_entrega} onChange={handleChange} className="batch-modal__input" />
            </div>
            ...
            <div className="batch-modal__field-card"><label className="batch-modal__label">Valor NF (R$)</label>
              <input type="number" min="0" name="valor_nf" value={valores.valor_nf} onChange={handleChange} className="batch-modal__input" placeholder="Deixar original" />
            </div>
            <div className="batch-modal__field-card"><label className="batch-modal__label">Valor Frete (R$)</label>
              <input type="number" min="0" name="valor" value={valores.valor} onChange={handleChange} className="batch-modal__input" placeholder="Deixar original" />
            </div>
