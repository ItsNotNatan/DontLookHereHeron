...
const extrairNumeroMoeda = (str) => {
  if (!str) return null; // Envia null em vez de '' para evitar erros no SQL
...
export default function CardEditavel({ atm, onCancelar, onSalvar }) {
  ...
  // 🟢 CORREÇÃO APLICADA: Lendo valor_previsto
  ...
  const handleSubmit = async (e) => {
    ...
    // TRAVA DE SEGURANÇA: Bloqueia salvamento de datas passadas
    ...
    const dadosParaEnviar = {
      ...
      nf: d.nf,
      // 🟢 CORREÇÃO APLICADA: Enviando valor_previsto no lugar de valor
